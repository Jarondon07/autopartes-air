...
- **Fase 4** ⏳ Dashboard real ✅ y Reportes ✅ (v1: ventas por día, top productos, cuadre por método, inventario valorizado — sin gráficos aún). Pendiente: **gráficos**, **impresión de recibos** y **Deudas** (`/ventas/deudas`, hoy toda venta es de contado).
...
**Módulos del server:** auth, users, roles, products, categories, brands, car-brands, car-models, vehicles, clients, suppliers, exchange-rates, inventory, purchases, sales, taxes, warehouses, uploads, reports.
